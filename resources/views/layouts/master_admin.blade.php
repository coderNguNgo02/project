...
<head>
    ...
    <link rel="manifest" href="/template_admin/assets/favicon/manifest.json">
    ...
    <link href="/template_admin/vendors/@coreui/chartjs/css/coreui-chartjs.css" rel="stylesheet">
...
<body>
    <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
        <div class="sidebar-brand d-none d-md-flex">
            <svg class="sidebar-brand-full" width="118" height="46" alt="CoreUI Logo">
                <use xlink:href="/template_admin/assets/brand/coreui.svg#full"></use>
            </svg>
            <svg class="sidebar-brand-narrow" width="46" height="46" alt="CoreUI Logo">
                <use xlink:href="/template_admin/assets/brand/coreui.svg#signet"></use>
            </svg>
        </div>
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('index_admin') }}">
                    <svg class="nav-icon">
                        <use xlink:href="/template_admin/vendors/@coreui/icons/svg/free.svg#cil-speedometer"></use>
                    </svg> Dashboard
                </a>
                <a class="nav-link" href="{{ route('account_admin') }}">
                    <svg class="nav-icon">
                        <use xlink:href="/template_admin/vendors/@coreui/icons/svg/free.svg#cil-user"></use>
                    </svg> Quản lý tài khoản
                </a>
                <a class="nav-link" href="{{ route('content_admin') }}">
                    <svg class="nav-icon">
                        <use xlink:href="/template_admin/vendors/@coreui/icons/svg/free.svg#cil-library-add"></use>
                    </svg> Quản lý nội dung
                </a>
                <a class="nav-link" href="{{ route('category_admin') }}">
                    <svg class="nav-icon">
                        <use xlink:href="/template_admin/vendors/@coreui/icons/svg/free.svg#cil-library-add"></use>
                ...
                <a class="nav-link" href="{{ route('product_admin') }}">
                    <svg class="nav-icon">
                        <use xlink:href="/template_admin/vendors/@coreui/icons/svg/free.svg#cil-laptop"></use>
                    </svg> Quản lý sản phẩm
                </a>
                <a class="nav-link" href="{{ route('order_admin') }}">
                    <svg class="nav-icon">
                        <use xlink:href="/template_admin/vendors/@coreui/icons/svg/free.svg#cil-cart"></use>
    ...
    <script src="/template_admin/vendors/chart.js/js/chart.min.js"></script>
    <script src="/template_admin/vendors/@coreui/chartjs/js/coreui-chartjs.js"></script>
    <script src="/template_admin/vendors/@coreui/utils/js/coreui-utils.js"></script>
    <script src="/template_admin/js/main.js"></script>
